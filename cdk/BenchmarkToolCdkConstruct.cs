...
namespace AWS.CoreWCF.ServerExtensions.Cdk
{
    ...
    public class BenchmarkToolCdkConstruct
    {
        internal BenchmarkToolCdkConstruct(Stack scope, BenchmarkToolCdkStackProps props)
        {
            ...
            var benchmarkEC2InstanceProfile = CreateEC2InstanceProfileWithRole(scope, benchmarkEC2Role);

            AddPoliciesToTestRunnerRole(githubPerformanceTestRunnerRole, coreWcfSqsBenchmarkBucket, benchmarkEC2Role);
        ...
        internal CfnInstanceProfile CreateEC2InstanceProfileWithRole(Stack scope, Role benchmarkEC2Role)
        {
        ...
        internal void AddPoliciesToTestRunnerRole(
            Role testRunnerRole,
        ...
        )
        {
            ...
            benchmarkResultsBucket.GrantReadWrite(testRunnerRole);
        ...
        )
        {
            ...
            new CfnOutput(
                scope,
                "benchmarkEC2ProfileArn",
                new CfnOutputProps
                {
                    Value = benchmarkEC2InstanceProfile.AttrArn,
                    ExportName = "benchmarkEC2ProfileArn"
                }
            );
        }
    }
